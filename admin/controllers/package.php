 ...
 * Package Controller
 */
class ShadowsocksControllerPackage extends JControllerForm
{
	/**
	...
	protected function allowAdd($data = array())
	{
		...
		// Access check.
		$access = $user->authorise('package.access', 'com_shadowsocks');
		if (!$access)
		{
			return false;
		}
		...
		return $user->authorise('package.create', $this->option);
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_shadowsocks&view=packages' . $this->getRedirectToListAppend(), false));
