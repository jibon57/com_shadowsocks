...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'serverTab', 'details', JText::_('COM_SHADOWSOCKS_SERVER_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'serverTab', 'publishing', JText::_('COM_SHADOWSOCKS_SERVER_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'serverTab', 'permissions', JText::_('COM_SHADOWSOCKS_SERVER_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
