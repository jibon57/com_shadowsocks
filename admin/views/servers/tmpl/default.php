...
if ($this->saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_shadowsocks&task=servers.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_shadowsocks&view=servers'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
        ...
        <?php if ($this->canCreate && $this->canEdit) : ?>
            <?php echo JHtml::_(
                ...
                'collapseModal',
                array(
                    'title' => JText::_('COM_SHADOWSOCKS_SERVERS_BATCH_OPTIONS'),
