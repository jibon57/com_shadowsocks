...
/**
 * General Controller of Shadowsocks component
 */
class ShadowsocksController extends JControllerLegacy
{
	...
	public function __construct($config = array())
	{
		...
		$config['default_view'] = 'shadowsocks';
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		$view   = $this->input->getCmd('view', 'shadowsocks');
		...
		{
			if ($data['edit'] && $layout == 'edit' && !$this->checkEditId('com_shadowsocks.edit.'.$data['view'], $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_shadowsocks&view='.$data['views'], false));
				}
